...
import 'package:task/profile/add_card.dart';
...
class profile_payments extends StatefulWidget {
  const profile_payments({super.key});

  @override
  State<profile_payments> createState() => _profile_paymentsState();
}

class _profile_paymentsState extends State<profile_payments> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              payment_tile(title1: "Google     ", image: google_logo),
              payment_tile(title1: "Apple Pay", image: apple_logo),
              payment_tile(title1: "Facebook ", image: facebook_logo),
              GestureDetector(
          ...
          Container(
            child: TextButton(
              ...
              child: Text(
                "Connected",
                style:
                    TextStyle(color: purple_color, fontWeight: FontWeight.w700),
              ),
            ),
          ),
        ],
