...
class car_repair extends StatefulWidget {
  const car_repair({super.key});

  @override
  State<car_repair> createState() => _car_repairState();
}

class _car_repairState extends State<car_repair> {
  @override
            ...
            Row(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: ((context) => repairing_booking())));
                  },
                  child: Container(
                    child: Center(
                      child: Text(
