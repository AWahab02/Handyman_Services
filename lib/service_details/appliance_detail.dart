...
import 'package:task/service_details_2/appliance_booking.dart';
import 'package:task/widgets/Offers.dart';

import '../color_constants.dart';
import '../widgets/action_chip.dart';

class appliance_detail extends StatefulWidget {
  const appliance_detail({super.key});

  @override
  State<appliance_detail> createState() => _appliance_detailState();
}

class _appliance_detailState extends State<appliance_detail> {
  @override
            ...
            Row(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: ((context) => appliance_booking())));
                  },
                  child: Container(
                    child: Center(
                      child: Text(
