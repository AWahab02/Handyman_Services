...
import 'package:task/service_details_2/plumbing_booking.dart';
import 'package:task/widgets/Offers.dart';

import '../color_constants.dart';
import '../widgets/action_chip.dart';

class plumbing_detail extends StatefulWidget {
  const plumbing_detail({super.key});

  @override
  State<plumbing_detail> createState() => _plumbing_detailState();
}

class _plumbing_detailState extends State<plumbing_detail> {
  @override
            ...
            Row(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: ((context) => plumbing_booking())));
                  },
                  child: Container(
                    child: Center(
                      child: Text(
