...
import 'package:task/service_details_2/painting_booking.dart';
import 'package:task/widgets/Offers.dart';

import '../color_constants.dart';
import '../widgets/action_chip.dart';

class painting_detail extends StatefulWidget {
  const painting_detail({super.key});

  @override
  State<painting_detail> createState() => _painting_detailState();
}

class _painting_detailState extends State<painting_detail> {
  @override
            ...
            Row(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: ((context) => painting_booking())));
                  },
                  child: Container(
                    child: Center(
                      child: Text(
