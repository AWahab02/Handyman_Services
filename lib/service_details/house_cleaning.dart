...
import 'package:task/service_details_2/house_cleaning_1.dart';
import 'package:task/widgets/Offers.dart';

import '../color_constants.dart';
import '../widgets/action_chip.dart';

class cleaning_detail extends StatefulWidget {
  const cleaning_detail({super.key});

  @override
  State<cleaning_detail> createState() => _cleaning_detailState();
}

class _cleaning_detailState extends State<cleaning_detail> {
  @override
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Container(
              child: Image.asset(cleaning_icon),
            ),
            Padding(
            ...
            Row(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: ((context) => cleaning_booking())));
                  },
                  child: Container(
                    child: Center(
                      child: Text(
