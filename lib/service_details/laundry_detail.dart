...
import 'package:task/service_details_2/laundry_1.dart';
import 'package:task/widgets/Offers.dart';

import '../color_constants.dart';
import '../widgets/action_chip.dart';

class laundry_detail extends StatefulWidget {
  const laundry_detail({super.key});

  @override
  State<laundry_detail> createState() => _laundry_detailState();
}

class _laundry_detailState extends State<laundry_detail> {
  @override
            ...
            Row(
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: ((context) => laundry_booking())));
                  },
                  child: Container(
                    child: Center(
                      child: Text(
